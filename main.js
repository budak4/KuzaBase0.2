...
fs.existsSync('./WawebConnection/session.json') && kuza.loadAuthInfo('./WawebConnection/session.json')
kuza.on('connecting', () => {
...
fs.writeFileSync('./WawebConnection/session.json', JSON.stringify(kuza.base64EncodedAuthInfo(), null, '\t'))
